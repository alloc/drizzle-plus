...
describe('SQL helper type contracts', () => {
  ...
  test('universal functions preserve result and nullability types', () => {
    const universal = {
    ...
    expectTypeOf<SQLData<typeof universal.ceil>>().toEqualTypeOf<
      number | null
    >()
    expectTypeOf<SQLData<typeof universal.floor>>().toEqualTypeOf<number>()
    expectTypeOf<SQLData<typeof universal.sqrt>>().toEqualTypeOf<
      number | null
    >()
    expectTypeOf<SQLData<typeof universal.length>>().toEqualTypeOf<
      number | null
    >()
    expectTypeOf<SQLData<typeof universal.trim>>().toEqualTypeOf<
      string | null
    >()
    ...
    expectTypeOf<SQLData<typeof universal.power>>().toEqualTypeOf<
      number | null
    >()
    ...
    expectTypeOf<
      SQLData<typeof universal.concatNullable>
  ...
  test('value, case, and timestamp helpers preserve result types', () => {
    const values = {
      number: toSQL(1),
      boolean: toSQL(true),
      null: toSQL(null),
    ...
    expectTypeOf<SQLData<typeof caseNullResult>>().toEqualTypeOf<
      number | null
    >()
    ...
    expectTypeOf(nullableUuidTimestamp).toMatchTypeOf<
      SQLTimestamp<string | null>
    >()
    expectTypeOf<SQLData<typeof nullableUuidTimestamp>>().toEqualTypeOf<
      string | null
    >()
    expectTypeOf<
      SQLData<typeof nullableUuidDate>
    >().toEqualTypeOf<Date | null>()
    expectTypeOf<SQLData<ReturnType<typeof uuidv7>>>().toEqualTypeOf<string>()
  })

  test('dialect casts and JSON helpers preserve result types', () => {
    const casts = {
  ...
  test('dialect position, concatenation, and row helpers preserve types', () => {
    ...
    expectTypeOf<SQLData<typeof pgPositionResult>>().toEqualTypeOf<
      number | null
    >()
    ...
    expectTypeOf<SQLData<typeof mysqlConcatResult>>().toEqualTypeOf<
      string | null
    >()
